...
public class Money extends javax.swing.JFrame {
     ...
     */
   public Money(int idGame, int idUser) {
        this.idGame = idGame;
        this.idUser = idUser;
        initComponents();
        loadData(idGame);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mata Uang", "Jumlah", "Harga", "ID Mata Uang"
            }
        ));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 530, 230));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (selectedRow != -1) {
            int id_mata_uang = (int) jTable1.getValueAt(selectedRow, 3);
            new TransaksiF(id_mata_uang, idGame, idUser).setVisible(true);
            this.dispose();
        }
