 ...
 * @author lenovo
 */
public class MoneyF extends javax.swing.JFrame {

    /**
     * Creates new form MoneyF
     */
    public MoneyF() {
        initComponents();
        loadData();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 160, -1, 210));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (selectedRow != -1) {
            int id_game = (int) jTable1.getValueAt(selectedRow, 0);
            new MoneyGameF(id_game).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MoneyF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
